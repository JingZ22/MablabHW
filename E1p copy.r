...
mean(Aloss[1:aux2])    # [1] 422.1105
Xloss[aux2]            # [1] 116.7178
mean(Xloss[1:aux2])    # [1] 163.7176
Tloss[aux2]            # [1] 161.7368
mean(Tloss[1:aux2])    # [1] 233.3834
Mloss[aux2]            # [1] 121.6362
mean(Mloss[1:aux2])    # [1] 166.2264
...
#CVaR
mean(ploss[1:aux2])    #[1] 121.254

# portfolio VaR, CVaR smaller than individual ones
